...
CONSOLE_CMD(g_uac1, "usb", setup_usbd_uac1, CONSOLE_CMD_MODE_SELF,
	    "setup USB as UAC1 device demo")
...
CONSOLE_CMD(
	hid_kbd_demo, "usb", hid_kbd_demo, CONSOLE_CMD_MODE_SELF,
	"usb hid: get input event from USB keyboard, and send these data to usb hid gadget")
CONSOLE_CMD(
	hid_mouse_demo, "usb", hid_mouse_demo, CONSOLE_CMD_MODE_SELF,
	"usb hid: get input event from USB Mouse, and send these data to usb hid gadget")
CONSOLE_CMD(hid_dev_demo, "usb", hid_dev_demo_main, CONSOLE_CMD_MODE_SELF,
	    "usb hid dev demo")
